...
class Wine(models.Model):
    ...
    winetype = models.CharField(max_length=50, null=True, blank=True)
...
class VendorWine(models.Model):
    ...
    wine = models.ForeignKey(
        Wine, on_delete=models.CASCADE, related_name='vendors')
    vendor_code = models.CharField(max_length=50)
    volume = models.DecimalField(max_digits=5, decimal_places=3, default=0.75)
